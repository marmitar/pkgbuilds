...
- [hunk 0.17.7-2](https://aur.archlinux.org/packages/hunk)
- [intel-sgx-psw-bin 2.30-1](https://aur.archlinux.org/packages/intel-sgx-psw-bin)
- [intel-sgx-sdk-bin 2.30-1](https://aur.archlinux.org/packages/intel-sgx-sdk-bin)
